#!/usr/bin/env bash
# ============================================================================
# Deploys the central Azure Migrate Bicep to a resource group.
#
# Local test:   az login (or SP login), then:
#     ./deploy.sh <resource-group> environments/platform.params.json
#
...
PARAM_FILE="${2:?params file required, e.g. environments/platform.params.json}"
